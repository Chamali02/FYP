...
function Footer() {
  return (
    <>
    <footer className="p-4 bg-[#012915]">
    <div className="mx-auto max-w-screen-xl">
        <div className="md:flex md:justify-between">
            ...
            <div className="grid md:grid-cols-3 grid-cols-2 gap-10">
                <div>
                    <h2 className="mb-6 text-xl  text-white font-main">Company</h2>
                    <ul className=" ml-6 text-lg  text-white font-main">
                        <li className="mb-4">
                ...
                <div>
                    <h2 className="mb-6 text-xl  text-white font-main">Useful Links</h2>
                    <ul className=" ml-6 text-lg  text-white font-main">
                        <li className="mb-4">
                        <MenuLinks linkname='Login' url='/Login' />
                        </li>
                        <li className="mb-4">
                        <MenuLinks linkname='SignUp' url='/Register' />
                        </li>
                        <li className="mb-4">
                        <MenuLinks linkname='Privacy Policy' url='' />
                        </li>
                        <li className="mb-4">
                        <MenuLinks linkname='Terms & Conditions' url='' />
                        </li>
        ...
        <div className="sm:flex  sm:justify-between justify-center">
            <span className="text-sm text-white text-center  ">© 2023 GreenTourSLK. All rights reserved
            </span>
